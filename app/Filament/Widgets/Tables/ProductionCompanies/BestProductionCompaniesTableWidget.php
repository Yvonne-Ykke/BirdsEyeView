...
class BestProductionCompaniesTableWidget extends Widget implements HasForms, TableInterface
{
    use InteractsWithForms;

    protected static string $view = 'filament.widgets.best-production-companies-table-widget';
